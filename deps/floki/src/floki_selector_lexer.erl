...
-file("src/floki_selector_lexer.erl", 291).
yystate() -> 27.
...
yystate(28, Ics, Line, Tlen, _, _) ->
    {9,Tlen,Ics,Line};
yystate(27, [126|Ics], Line, Tlen, Action, Alen) ->
...
yystate(27, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [64|Ics], Line, Tlen, Action, Alen) ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
...
yystate(23, [10|Ics], Line, Tlen, _, _) ->
    yystate(15, Ics, Line+1, Tlen+1, 14, Tlen);
...
yystate(21, [10|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line+1, Tlen+1, 13, Tlen);
...
yystate(13, [10|Ics], Line, Tlen, _, _) ->
    yystate(13, Ics, Line+1, Tlen+1, 12, Tlen);
...
-file("src/floki_selector_lexer.xrl", 8).
yyaction_0(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/floki_selector_lexer.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { quoted, TokenLine, remove_quotes (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/floki_selector_lexer.xrl", 10).
yyaction_2(TokenChars, TokenLine) ->
     { token, { TokenChars, TokenLine } } .

-compile({inline,yyaction_3/2}).
-file("src/floki_selector_lexer.xrl", 11).
yyaction_3(TokenChars, TokenLine) ->
     { token, { hash, TokenLine, tail (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("src/floki_selector_lexer.xrl", 12).
yyaction_4(TokenChars, TokenLine) ->
     { token, { class, TokenLine, tail (TokenChars) } } .

-compile({inline,yyaction_5/1}).
-file("src/floki_selector_lexer.xrl", 13).
yyaction_5(TokenLine) ->
